  ...
  return (
    <>
      ...
      <div className="cv-page">
        <a
          href="#cv-main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-50 focus:px-4 focus:py-2 focus:bg-white focus:text-gray-900 focus:rounded focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-[var(--cv-coral,#e8604c)]"
        >
        ...
        {/* ============================================================
            HERO - THE BILLBOARD
            ============================================================ */}
        <section className="cv-hero" aria-label="Summary">
          <div className="cv-hero__inner">
            ...
            {/* 4 metric cards */}
            <ul className="cv-hero__metrics" role="list">
              <li className="cv-hero__metric">
            ...
            <div className="cv-hero__actions">
              ...
              <a href="https://linkedin.com/in/davidbehar" target="_blank" rel="noopener noreferrer" className="cv-hero__link" aria-label="Open LinkedIn profile (opens in new tab)">
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                LinkedIn
              </a>
              <a href="https://github.com/behagoras" target="_blank" rel="noopener noreferrer" className="cv-hero__link" aria-label="Open GitHub profile (opens in new tab)">
              ...
              <a href="mailto:davbelom@gmail.com" className="cv-hero__link" aria-label="Send email to davbelom@gmail.com">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 7l-10 7L2 7"/></svg>
                davbelom@gmail.com
              </a>
            </div>
          </div>
        ...
        <main id="cv-main-content">
          {/* ============================================================
              EXPERIENCE - TIMELINE
              ============================================================ */}
          <section className="cv-experience" aria-label="Work experience">
          ...
          {/* ============================================================
              HIGHLIGHT BAND 1
              ============================================================ */}
          <section className="cv-highlight-band cv-animate" aria-label="Module Federation achievement highlight">
            <div className="cv-highlight-band__inner">
              <h3 className="cv-highlight-band__title">Webpack Module Federation Migration</h3>
              <div className="cv-highlight-band__number cv-highlight-band__number--coral" aria-hidden="true">~35%</div>
              <p className="cv-highlight-band__text">
                <strong>~35% faster page loads</strong> after decomposing a ~4MB monolithic bundle into 20+
          ...
          <section className="cv-highlight-band cv-highlight-band--second cv-animate" aria-label="CI/CD achievement highlight">
            <div className="cv-highlight-band__inner">
              <h3 className="cv-highlight-band__title">CI/CD Pipeline Optimization</h3>
              <div className="cv-highlight-band__number cv-highlight-band__number--teal" aria-hidden="true">50%</div>
              <p className="cv-highlight-band__text">
                <strong>50% build time reduction</strong> through incremental builds, pipeline parallelization,
          ...
          {/* ============================================================
              ...
              ============================================================ */}
          <section className="cv-skills-section" aria-label="Technical skills">
            <div className="cv-skills-section__inner">
              ...
              <div className="cv-skills__grid">
                ...
                <div className="cv-skill-card cv-animate cv-animate-delay-1">
                  ...
                  <ul className="cv-skill-card__tags" role="list">
                    <li className="inline"><SkillTag name="TypeScript" icon="typescript" /></li>
                    <li className="inline"><SkillTag name="JavaScript" icon="javascript" /></li>
                    <li className="inline"><SkillTag name="React" icon="react" /></li>
                    <li className="inline"><SkillTag name="Redux" icon="redux" /></li>
                    <li className="inline"><SkillTag name="HTML5" icon="html5" /></li>
                    <li className="inline"><SkillTag name="CSS3" icon="css3" /></li>
                    <li className="inline"><SkillTag name="styled-components" /></li>
                    <li className="inline"><SkillTag name="State Management" /></li>
                  </ul>
                </div>
                ...
                <div className="cv-skill-card cv-animate cv-animate-delay-2">
                  ...
                  <ul className="cv-skill-card__tags" role="list">
                    <li className="inline"><SkillTag name="Claude Code" /></li>
                    <li className="inline"><SkillTag name="OpenAI Codex" /></li>
                    <li className="inline"><SkillTag name="AI Refactoring" /></li>
                    <li className="inline"><SkillTag name="Context Engineering" /></li>
                    <li className="inline"><SkillTag name="Multi-Agent Orchestration" /></li>
                  </ul>
                </div>
                ...
                <div className="cv-skill-card cv-animate cv-animate-delay-3">
                  ...
                  <ul className="cv-skill-card__tags" role="list">
                    <li className="inline"><SkillTag name="Core Web Vitals" /></li>
                    <li className="inline"><SkillTag name="Lighthouse CI" /></li>
                    <li className="inline"><SkillTag name="Code Splitting" /></li>
                    <li className="inline"><SkillTag name="Lazy Loading" /></li>
                    <li className="inline"><SkillTag name="PWA" /></li>
                    <li className="inline"><SkillTag name="Bundle Optimization" /></li>
                    <li className="inline"><SkillTag name="Caching Strategies" /></li>
                  </ul>
                </div>
                ...
                <div className="cv-skill-card cv-animate cv-animate-delay-4">
                  ...
                  <ul className="cv-skill-card__tags" role="list">
                    <li className="inline"><SkillTag name="Webpack" icon="webpack" /></li>
                    <li className="inline"><SkillTag name="Jest" icon="jest" /></li>
                    <li className="inline"><SkillTag name="Cypress" /></li>
                    <li className="inline"><SkillTag name="Vitest" /></li>
                    <li className="inline"><SkillTag name="Storybook" icon="storybook" /></li>
                    <li className="inline"><SkillTag name="CI/CD" /></li>
                    <li className="inline"><SkillTag name="Jenkins" icon="jenkins" /></li>
                    <li className="inline"><SkillTag name="Azure DevOps" icon="azure" /></li>
                  </ul>
                </div>
                ...
                <div className="cv-skill-card cv-animate cv-animate-delay-5">
                  ...
                  <ul className="cv-skill-card__tags" role="list">
                    <li className="inline"><SkillTag name="Node.js" icon="nodejs" /></li>
                    <li className="inline"><SkillTag name="REST APIs" /></li>
                    <li className="inline"><SkillTag name="GraphQL" icon="graphql" /></li>
                    <li className="inline"><SkillTag name="AWS Lambda" icon="amazonwebservices" /></li>
                    <li className="inline"><SkillTag name="API Gateway" /></li>
                    <li className="inline"><SkillTag name="EventBridge" /></li>
                    <li className="inline"><SkillTag name="S3" /></li>
                    <li className="inline"><SkillTag name="Serverless" /></li>
                  </ul>
                </div>
                ...
                <div className="cv-skill-card cv-animate cv-animate-delay-6">
                  ...
                  <ul className="cv-skill-card__tags" role="list">
                    <li className="inline"><SkillTag name="Microfrontends" /></li>
                    <li className="inline"><SkillTag name="Module Federation" /></li>
                    <li className="inline"><SkillTag name="DX Tooling" /></li>
                    <li className="inline"><SkillTag name="Responsive Design" /></li>
                    <li className="inline"><SkillTag name="Scalable Systems" /></li>
                    <li className="inline"><SkillTag name="Event-Driven Patterns" /></li>
                    <li className="inline"><SkillTag name="Git" icon="git" /></li>
                    <li className="inline"><SkillTag name="Agile/Scrum" /></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {/* ============================================================
              ...
              ============================================================ */}
          <section className="cv-bottom-section" aria-label="Education and languages">
            <div className="cv-bottom-section__inner">
              <div className="cv-bottom-grid">
                ...
                <div>
                  ...
                  <dl className="cv-languages cv-animate cv-animate-delay-1">
                    <div className="cv-language">
                      <dt className="cv-language__name">Spanish</dt>
                      <dd className="cv-language__level">Native</dd>
                    </div>
                    <div className="cv-language">
                      <dt className="cv-language__name">English</dt>
                      <dd className="cv-language__level">Advanced</dd>
                    </div>
                    <div className="cv-language">
                      <dt className="cv-language__name">Hebrew</dt>
                      <dd className="cv-language__level">Intermediate</dd>
                    </div>
                  </dl>
                </div>
              </div>
          ...
          {/* ============================================================
              CTA BAND - DOWNLOAD
              ============================================================ */}
          <section className="cv-cta-band cv-animate" aria-label="Download CV">
