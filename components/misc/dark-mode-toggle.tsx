...
export default function DarkModeToggle() {
  ...
  if (!mounted) {
    return (
      <button
        className="p-2 rounded-lg transition-colors duration-200 hover:bg-gray-200 dark:hover:bg-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--coral,#e8604c)] focus-visible:ring-offset-2"
