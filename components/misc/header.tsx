      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          <h2 className="shrink-0 mr-4 text-2xl font-bold tracking-tight md:tracking-tighter leading-tight text-gray-900 dark:text-dark-text">
            <Link href="/" className="block hover:underline" aria-label="behar.io home">
              behar.io
            </Link>
          </h2>
          <ul className="flex grow justify-end flex-wrap items-center gap-2">
            <li>
              <Link href="/about" className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors duration-200 px-2 py-1">
                About
              </Link>
            </li>
            <li>
              <Link href="/cv" className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors duration-200 px-2 py-1">
                CV
              </Link>
            </li>
            <li>
